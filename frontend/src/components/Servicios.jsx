...
const Servicios = () => {
  ...
  return (
    <div className="md:px-14 px-4 py-16 max-w-screen-2xl mx-auto text-center my-8" id="clientes">
      ...
      {/* Sobre Nosotros */}
      <div className="px-4 lg:px-14 max-w-screen-2xl mx-auto my-8 " id="servicio">
